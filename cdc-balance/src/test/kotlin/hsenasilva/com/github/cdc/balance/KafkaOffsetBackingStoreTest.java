...
//    private static final short TOPIC_PARTITIONS = 1;
...
//        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_REPLICATION_FACTOR_CONFIG, null);
//        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_PARTITIONS_CONFIG, null);
        DistributedConfig NULLABLE_DISTRIBUTED_CONFIG = new DistributedConfig(DEFAULT_PROPS);

        System.out.println("BATEU: " + NULLABLE_DISTRIBUTED_CONFIG.getInt(DistributedConfig.OFFSET_STORAGE_PARTITIONS_CONFIG));

        store.configure(NULLABLE_DISTRIBUTED_CONFIG);
...
//    @Test(expected = NullPointerException.class)
    public void testShouldNotNullOffsetStoragePartitions() throws Exception {
        ...
        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_REPLICATION_FACTOR_CONFIG, null);
//        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_PARTITIONS_CONFIG, Integer.toString(TOPIC_PARTITIONS));
        final DistributedConfig NULLABLE_DISTRIBUTED_CONFIG = new DistributedConfig(DEFAULT_PROPS);

        store.configure(NULLABLE_DISTRIBUTED_CONFIG);
    }

//    @Test
    public void testShouldNotNullOffsetStoragePartitionsConfigException() throws Exception {
...
//        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_REPLICATION_FACTOR_CONFIG, null);
////        DEFAULT_PROPS.put(DistributedConfig.OFFSET_STORAGE_PARTITIONS_CONFIG, Integer.toString(TOPIC_PARTITIONS));
//        System.out.println("BATEU: " + NULLABLE_DISTRIBUTED_CONFIG.getInt(DistributedConfig.OFFSET_STORAGE_REPLICATION_FACTOR_CONFIG));
//        final DistributedConfig NULLABLE_DISTRIBUTED_CONFIG = new DistributedConfig(DEFAULT_PROPS);
//
//        store.configure(NULLABLE_DISTRIBUTED_CONFIG);
    }
